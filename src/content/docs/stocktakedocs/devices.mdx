...
##### Wireless bluetooth scanner through Shopify POS
You can use your normal bluetooth scanner (generally a Socket Mobile scanner) through our Shopify POS app. This works in application mode and shouldn't require any changes to the settings if using POS already.
