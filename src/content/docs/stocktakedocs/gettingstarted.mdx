...
<CardGrid>
  <LinkCard title="Stock Take Filters" href="/scanpickerdocs/packingslips" />
  <LinkCard title="Stock Take Automations" href="/scanpickerdocs/packingslipstemplate" />
</CardGrid>
...
3. **Use the Shopify POS app**: On the Shopify POS app add a tile from Twist: Stock Take, you can now scan items for an existing unprocessed stock take here. You cannot edit any stock take settings here.
...
<Aside type="tip" title="Tip">
Using the POS app is very useful if you want to limit your staff access to the Stock Take settings. the POS app only allows for scanning items into a stock take and does not allow for directly actioning or editing the stock take.
</Aside>
